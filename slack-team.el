...
(defclass slack-team ()
  ((id :initarg :id :initform nil)
   ...
   (file-list-mutation-revision :initform 0 :type integer)
   (file-list-mutations :initform (make-hash-table :test 'equal)
                        :type hash-table)
   (file-list-mutation-snapshots :initform nil :type list)
   (counts :initform nil)
